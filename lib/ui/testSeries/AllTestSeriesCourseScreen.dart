...
class AllTestSeriesCourseScreen extends StatefulWidget {
  final String catID;
  final String title;
  final bool isShowHeader;
  const AllTestSeriesCourseScreen({super.key, required this.catID, required this.title, required this.isShowHeader});

  @override
  State<StatefulWidget> createState() => _AllTestSeriesCourseScreenState();
}

class _AllTestSeriesCourseScreenState extends State<AllTestSeriesCourseScreen>{
  ...
  Widget tabvew() {
    ...
    return Column(
      ...
      children: [
        Flexible(
          child: allCourseList.isEmpty ? Center(child: emptyWidget(context, "No test course found", onRefresh: getData)) : ListView.builder(
                  ...
                  InkWell(
                    onTap: (){
                        if(product.subType == 1){
                          Get.to(() => TestSeriesCourseDetailsScreen(courseData: product, cImage: imageUrl.value+product.subPackImage));
                        }else{
                          ...
                          Get.to(() => MyTestSeriesDetailScreen(courseData: product1, cImage: imageUrl.value+product.subPackImage));
                        }
                    },
                    child: Container(
                      width: screenWidth,
                      ...
                      child: Row(
                        ...
                        children: [
                          setCachedImage(
                            imageUrl.value+product.subPackImage,
                            90, 145, 5,
                          ),
                          Expanded(
                            child: Padding(
