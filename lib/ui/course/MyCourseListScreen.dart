...
class MyCourseListScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _MyCourseListScreenState();
}
        ...
        Flexible(
          child: catCtrl.myeCourseList.isEmpty ? Center(child: emptyWidget(context, "No Course found", onRefresh: getData)) : ListView.builder(
            ...
            itemBuilder: (context, index) {
              final product = catCtrl.myeCourseList[index].belongsToCsCourses;
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: Theme.of(context).textTheme.titleMedium?.copyWith(
                                  color: myprimarycolor, fontSize: 12, fontWeight: FontWeight.normal
                              ),),
                          )
                        ],
                      ),
